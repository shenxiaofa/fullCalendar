<%@page import="com.cetc.roman.fullcalendar.domain.Calendar"%>
<%@page import="com.cetc.roman.fullcalendar.dao.CalendarDao"%>
...
<div class="fancy">
	<h3>新建事件</h3>
    <form id="add_form" action="EventDoServlet" method="post">
